...
{
    public class ErollementController : Controller
    {
        private readonly ILogger<ErollementController> _logger;
        private ICourese icourse;
        private IRollments irollements;
        private IStudent istudent;


        public ErollementController(ILogger<ErollementController> logger, ICourese icourse,
